...
public class FuncionService {
    ...
    public Optional<Funcion> actualizarFuncion(FuncionDTO dto){
        ...
        if(!funcionRepository.cruce(funcion.getSala().getId(), funcion.getFechaHoraInicio(), funcion.getFechaHoraFin(), funcion.getId()) //no se haber cruce
    ...
    public Optional<Funcion> save(FuncionDTO dto){
        ...
        System.out.println(funcion.getFechaHoraFin().toLocalTime());
        if(!funcionRepository.cruce(funcion.getSala().getId(), funcion.getFechaHoraInicio(), funcion.getFechaHoraFin(), funcion.getId())
                && !funcion.getFechaHoraInicio().toLocalTime().isBefore(LocalTime.of(8, 30))   // hora inicio >= 08:30
                && !funcion.getFechaHoraInicio().toLocalTime().isAfter(LocalTime.of(22, 30)) )  // hora inicio <= 20:30
        {
            funcionRepository.save(funcion);
