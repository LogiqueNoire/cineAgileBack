...
public class PeliculaService implements PeliculaRepository{
    ...
    @Override
    public void deleteInBatch(Iterable<Pelicula> entities) {
        PeliculaRepository.super.deleteInBatch(entities); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/OverriddenMethodBody
    }
